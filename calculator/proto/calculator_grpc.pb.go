...
type CalculatorServiceClient interface {
	...
	Factor(ctx context.Context, in *FactorRequest, opts ...grpc.CallOption) (CalculatorService_FactorClient, error)
...
func (c *calculatorServiceClient) Factor(ctx context.Context, in *FactorRequest, opts ...grpc.CallOption) (CalculatorService_FactorClient, error) {
	stream, err := c.cc.NewStream(ctx, &CalculatorService_ServiceDesc.Streams[0], "/calculator.CalculatorService/Factor", opts...)
	if err != nil {
		return nil, err
	}
	x := &calculatorServiceFactorClient{stream}
...
type CalculatorService_FactorClient interface {
	Recv() (*FactorResponse, error)
	grpc.ClientStream
}

type calculatorServiceFactorClient struct {
	grpc.ClientStream
}

func (x *calculatorServiceFactorClient) Recv() (*FactorResponse, error) {
...
type CalculatorServiceServer interface {
	...
	Factor(*FactorRequest, CalculatorService_FactorServer) error
...
func (UnimplementedCalculatorServiceServer) Factor(*FactorRequest, CalculatorService_FactorServer) error {
...
func _CalculatorService_Factor_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(FactorRequest)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(CalculatorServiceServer).Factor(m, &calculatorServiceFactorServer{stream})
}

type CalculatorService_FactorServer interface {
	Send(*FactorResponse) error
	grpc.ServerStream
}

type calculatorServiceFactorServer struct {
	grpc.ServerStream
}

func (x *calculatorServiceFactorServer) Send(m *FactorResponse) error {
...
var CalculatorService_ServiceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		{
			StreamName:    "Factor",
			Handler:       _CalculatorService_Factor_Handler,
			ServerStreams: true,
		},
		{
			StreamName:    "Max",
